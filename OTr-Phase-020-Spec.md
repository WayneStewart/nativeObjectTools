...
|   | Phase 8 — Side-by-Side Compatibility Testing | [OTr-Phase-008-Spec.md](OTr-Phase-008-Spec.md) |
...
- [ ] Write test method `____Test_OT_Compatibility` per [OTr-Phase-008-Spec.md](OTr-Phase-008-Spec.md); register in `Test Methods` group in `folders.json`
- [ ] Confirm side-by-side testing performed on a compatible platform — see [OTr-Phase-008-Spec.md §2](OTr-Phase-008-Spec.md)
...
*Items a caller must address when migrating from ObjectTools 5.0 to OTr. See [OTr-Phase-008-Spec.md §4](OTr-Phase-008-Spec.md) for the full incompatibility catalogue.*
...
- [ ] Side-by-side compatibility testing passed per [OTr-Phase-008-Spec.md](OTr-Phase-008-Spec.md)
