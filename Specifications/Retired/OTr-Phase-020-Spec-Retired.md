> **RETIRED — SUPERSEDED**  
> This document has been superseded by **OTr-Phase-020-Spec.md** and is retained for historical reference only. Do not edit. Do not use as an implementation reference.
