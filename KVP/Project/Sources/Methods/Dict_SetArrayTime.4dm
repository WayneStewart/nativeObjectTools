...
// ----------------------------------------------------
// Project Method: Dict_SetArrayTime
...
//   Dict_SetArrayTime(Dictionary; Key; inIndex; inValue) 
...
If (Dict_IsValid($DictionaryID_i))
	...
	Dict_SetTime($DictionaryID_i; $ElementKeyLabel_t; $inValue_h)
End if 
