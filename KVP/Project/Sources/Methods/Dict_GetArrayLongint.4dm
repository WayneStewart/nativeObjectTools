...
// ----------------------------------------------------
// Project Method: Dict_GetArrayLongint
...
C_LONGINT:C283($0; $outArrayElement_i)
...
//   Dict_GetArrayLongint(Dictionary; Key; inIndex) => Number 
...
If (Dict_IsValid($DictionaryID_i))
	...
	$outArrayElement_i:=Dict_GetLongint($DictionaryID_i; $ElementKeyLabel_t)
End if 
