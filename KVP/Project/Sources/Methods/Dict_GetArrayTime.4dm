...
// ----------------------------------------------------
// Project Method: Dict_GetArrayTime
...
C_TIME:C306($0; $outArrayElement_h)
...
//   Dict_GetArrayTime(Dictionary; Key; inIndex) => Time 
...
If (Dict_IsValid($DictionaryID_i))
	...
	$outArrayElement_h:=Dict_GetTime($DictionaryID_i; $ElementKeyLabel_t)
End if 
