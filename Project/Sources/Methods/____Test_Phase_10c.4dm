...
// ----------------------------------------------------
// Project Method: ____Test_Phase_10c

// Controller for the Phase 10c comprehensive OK=0
// side-by-side test suite. Covers every OT command that
// the legacy ObjectTools 5 documentation specifies sets
// OK to zero on an error condition.
//
...
If (Current process name:C1392=$DesiredProcessName_t)
	...
	$fileName_t:="____Test_Phase_10c-"+$dateStr_t+"-"+$timeStr_t+".txt"
