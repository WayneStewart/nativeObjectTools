...
// ----------------------------------------------------
// Project Method: OT PutArrayDate (inObject; inTag; inIndex; inValue)

// Sets a single element of a Date array item at the given index. See OT SetDateMode.
...
//   match OT PutDate strategy. See OTr_u_NativeDateInObject for probe details.
// ----------------------------------------------------
