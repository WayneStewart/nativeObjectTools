...
// ----------------------------------------------------
// Project Method: OTr_u_MapType ($nativeType_i : Integer {; $direction_i : Integer}) --> $result_i : Integer
...
// native-storage architecture) see OTr_z_MapType.
...
//   arrays. Used by OTr_z_MapType when descending into an OTr array-container
//   sub-object.
// ----------------------------------------------------
...
If ($dir_i=0)
	...
	Case of 
		...
		: ($nativeType_i=String array:K8:15) | ($nativeType_i=Text array:K8:16)
			$result_i:=OT Character array
			
		: ($nativeType_i=Real array:K8:17)
			$result_i:=Is real:K8:4
			
		: ($nativeType_i=Integer array:K8:18) | ($nativeType_i=LongInt array:K8:19)
			$result_i:=Is longint:K8:6
			
		: ($nativeType_i=Date array:K8:20)
			$result_i:=Is date:K8:7
			
		: ($nativeType_i=Time array:K8:29)
			$result_i:=Is time:K8:8
			
		: ($nativeType_i=Boolean array:K8:21)
			$result_i:=Is boolean:K8:9
			
		: ($nativeType_i=Picture array:K8:22)
			$result_i:=Is picture:K8:10
			
		: ($nativeType_i=Blob array:K8:30)
			$result_i:=Is BLOB:K8:12
			
		: ($nativeType_i=Pointer array:K8:23)
			$result_i:=Is pointer:K8:14
