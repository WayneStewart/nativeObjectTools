...
// Wayne Stewart / Claude, 2026-08-09 - Added declarations for
//       OTr_u_IPArrayAccess (W7 Inner layer), which had none.
// ----------------------------------------------------

If (False:C215)
	
	C_BOOLEAN:C305(_____________v4_CompilerCheck; $1)
	...
	C_VARIANT:C1683(OTr_u_IPArrayAccess; $0; $6)
	C_LONGINT:C283(OTr_u_IPArrayAccess; $1; $3; $4; $5)
	C_TEXT:C284(OTr_u_IPArrayAccess; $2)
