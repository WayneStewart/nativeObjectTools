...
// ----------------------------------------------------
// Project Method: OTr_zIsShadowKey ($key_t : Text) --> Boolean
...
// shadow keys from callers, and by OTr_zMapType to avoid
// recursively mapping a shadow as if it were a user property.
//
// Paired with OTr_zShadowKey which constructs shadow keys.
