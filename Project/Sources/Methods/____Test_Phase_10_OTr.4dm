...
// ====================================================
$otrCmd_t:="OT GetLong($otrMain_i; \"doesNotExist\")"
$otrResult_t:="Fail: not run"

$gotLong_i:=OT GetLong($otrMain_i; "doesNotExist")
$otrResult_t:="returned "+String($gotLong_i)+" OK="+String(OK)
...
// ====================================================
$otrCmd_t:="OT GetPointer($otrMain_i; \"missingPtr\"; ->$gotPtr_ptr)"
$otrResult_t:="Fail: not run"

$gotPtr_ptr:=Null
OT GetPointer($otrMain_i; "missingPtr"; ->$gotPtr_ptr)
$otrResult_t:="OK="+String(OK)
...
// ====================================================
$otrCmd_t:="OT Register(\"20C9-EMQv-BJBl-D20M\")"
$otrResult_t:="Fail: not run"
