...
// ====================================================
$otrCmd_t:="OT Register / OT GetVersion / OT CompiledApplication / OT GetOptions"
...
// ====================================================
OT PutString($otrMain_i; "str"; "hello")
OT PutLong($otrMain_i; "num"; 42)
OT PutReal($otrMain_i; "real"; 3.5)
OT PutBoolean($otrMain_i; "bool"; True:C214)
OT PutDate($otrMain_i; "date"; $testDate_d)
OT PutTime($otrMain_i; "time"; $testTime_h)
$gotLong_i:=OT GetLong($otrMain_i; "num")
$gotReal_r:=OT GetReal($otrMain_i; "real")
$gotBool_i:=OT GetBoolean($otrMain_i; "bool")
$otrCmd_t:="OTr Put/Get String Long Real Boolean Date Time"
$otrResult_t:=OT GetString($otrMain_i; "str")+" / "+String:C10($gotLong_i)+" / "+String:C10($gotReal_r)+" / "+String:C10($gotBool_i)
...
OT PutBLOB($otrMain_i; "blob"; $gotBlob_blob)
OT PutPicture($otrMain_i; "pic"; $wombat_pic)
$ptrOut_ptr:=Null:C1517
OT GetPointer($otrMain_i; "ptr"; ->$ptrOut_ptr)
$roundBlob_blob:=OT GetNewBLOB($otrMain_i; "blob")
...
// ====================================================
$testOtrH_i:=OT New
OT PutString($testOtrH_i; "childName"; "kid")
OT PutObject($otrMain_i; "child"; $testOtrH_i)
$h2_i:=OT GetObject($otrMain_i; "child")
$otrCmd_t:="OTr PutObject / OTr GetObject"
$otrResult_t:="childHandle="+String:C10($h2_i)+" childName="+OT GetString($h2_i; "childName")
...
// ====================================================
$varLong_i:=1234
OT PutVariable($otrMain_i; "varLong"; ->$varLong_i)
$varLong_i:=0
OT GetVariable($otrMain_i; "varLong"; ->$varLong_i)
...
$longArr_ai{2}:=20
$longArr_ai{3}:=30
OT PutArray($otrMain_i; "arr"; ->$longArr_ai)
OT PutArrayLong($otrMain_i; "arr"; 2; 99)
OT InsertElement($otrMain_i; "arr"; 2)
OT PutArrayLong($otrMain_i; "arr"; 2; 77)
OT DeleteElement($otrMain_i; "arr"; 4)
$arraySize_i:=OT SizeOfArray($otrMain_i; "arr")
$gotLong_i:=OT GetArrayLong($otrMain_i; "arr"; 2)
...
// ====================================================
OT ResizeArray($otrMain_i; "arr"; 5)
OT PutArrayLong($otrMain_i; "arr"; 5; 555)
ARRAY LONGINT:C221($longArrOut_ai; 0)
OT GetArray($otrMain_i; "arr"; ->$longArrOut_ai)
$find_i:=OT FindInArray($otrMain_i; "arr"; String:C10(555))
...
// ====================================================
$itemCount_i:=OT ItemCount($otrMain_i)
$itemType_i:=OT ItemType($otrMain_i; "str")
$otrCmd_t:="OTr IsObject / ItemCount / ItemType / ObjectSize"
$otrResult_t:="isObject="+String:C10(OT IsObject($otrMain_i))+" itemCount="+String:C10($itemCount_i)+" itemType(str)="+String:C10($itemType_i)+" size="+String:C10(OT ObjectSize($otrMain_i))
...
ARRAY LONGINT:C221($itemSizes_ai; 0)
ARRAY LONGINT:C221($dataSizes_ai; 0)
OT GetAllProperties($otrMain_i; ->$names_at; ->$types_ai; ->$itemSizes_ai; ->$dataSizes_ai)
$otrCmd_t:="OTr GetAllProperties / ItemExists / IsEmbedded"
$otrResult_t:="allProps="+String:C10(Size of array:C274($names_at))+" exists(str)="+String:C10(OT ItemExists($otrMain_i; "str"))+" embedded(child)="+String:C10(OT IsEmbedded($otrMain_i; "child"))
...
// ====================================================
OT CopyItem($otrMain_i; "str"; $otrMain_i; "strCopy")
$compare_i:=OT CompareItems($otrMain_i; "str"; $otrMain_i; "strCopy")
OT RenameItem($otrMain_i; "strCopy"; "strRenamed")
OT DeleteItem($otrMain_i; "strRenamed")
$otrCmd_t:="OTr CopyItem / CompareItems / RenameItem / DeleteItem"
$otrResult_t:="compare="+String:C10($compare_i)+" existsAfterDelete="+String:C10(OT ItemExists($otrMain_i; "strRenamed"))
...
// 11. Serialisation
// ====================================================
$gotBlob_blob:=OT ObjectToNewBLOB($otrMain_i)
$testOtrH_i:=OT BLOBToObject($gotBlob_blob)
$otrCmd_t:="OTr ObjectToNewBLOB / BLOBToObject"
$otrResult_t:="blobSize="+String:C10(BLOB size:C605($gotBlob_blob))+" newHandle="+String:C10($testOtrH_i)+" getStr="+OT GetString($testOtrH_i; "str")
