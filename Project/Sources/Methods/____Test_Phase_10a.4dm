...
If (Current process name:C1392=$DesiredProcessName_t)
	...
	If ($ready_b)
		...
		$otResult_t:="size="+String:C10(Size of array:C274(longArr_ai))+" find555="+String:C10($find_i)
		
		ARRAY LONGINT:C221($longArrOut_ai; 0)
		OTr_ResizeArray($otrMain_i; "arr"; 5)
		OTr_PutArrayLong($otrMain_i; "arr"; 5; 555)
		OTr_GetArray($otrMain_i; "arr"; ->$longArrOut_ai)
		$otrResult_t:="size="+String:C10(Size of array:C274($longArrOut_ai))+" find555="+String:C10(OTr_FindInArray($otrMain_i; "arr"; String:C10(555)))
