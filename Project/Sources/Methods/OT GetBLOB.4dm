...
// 
// Use OT GetNewBLOB instead, which returns the BLOB as
// a function result.
...
// parameter. Use OT GetNewBLOB in preference.
...
OTr_zError("OT GetBLOB is not implemented. Use OT GetNewBLOB instead."; Current method name)
OTr_zSetOK(0)
