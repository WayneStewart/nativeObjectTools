...
If (Current process name:C1392=$DesiredProcessName_t)
	...
	Else 
		$failed_i:=$failed_i+1
		$failures_t:=$failures_t+"Put/GetLong failed."+Char:C90(Carriage return:K15:38)
	End if 
	...
	Else 
		$failed_i:=$failed_i+1
		$failures_t:=$failures_t+"Put/GetReal failed."+Char:C90(Carriage return:K15:38)
	End if 
	...
	Else 
		$failed_i:=$failed_i+1
		$failures_t:=$failures_t+"Put/GetString failed."+Char:C90(Carriage return:K15:38)
	End if 
	...
	Else 
		$failed_i:=$failed_i+1
		$failures_t:=$failures_t+"Put/GetText failed."+Char:C90(Carriage return:K15:38)
	End if 
	...
	Else 
		$failed_i:=$failed_i+1
		$failures_t:=$failures_t+"Put/GetDate failed."+Char:C90(Carriage return:K15:38)
	End if 
	...
	Else 
		$failed_i:=$failed_i+1
		$failures_t:=$failures_t+"Put/GetTime failed."+Char:C90(Carriage return:K15:38)
	End if 
	...
	Else 
		$failed_i:=$failed_i+1
		$failures_t:=$failures_t+"Put/GetBoolean failed for True."+Char:C90(Carriage return:K15:38)
	End if 
	...
	Else 
		$failed_i:=$failed_i+1
		$failures_t:=$failures_t+"Put/GetBoolean failed for False."+Char:C90(Carriage return:K15:38)
	End if 
	...
	Else 
		$failed_i:=$failed_i+1
		$failures_t:=$failures_t+"GetObject did not return a handle."+Char:C90(Carriage return:K15:38)
	End if 
	...
	Else 
		$failed_i:=$failed_i+1
		$failures_t:=$failures_t+"Put/GetObject content check failed."+Char:C90(Carriage return:K15:38)
	End if 
	...
	Else 
		$failed_i:=$failed_i+1
		$failures_t:=$failures_t+"GetObject should return deep copy semantics."+Char:C90(Carriage return:K15:38)
	End if 
	...
	Else 
		$failed_i:=$failed_i+1
		$failures_t:=$failures_t+"Missing long default should be 0."+Char:C90(Carriage return:K15:38)
	End if 
	...
	Else 
		$failed_i:=$failed_i+1
		$failures_t:=$failures_t+"Missing text default should be empty."+Char:C90(Carriage return:K15:38)
	End if 
