//%attributes = {"invisible":true,"shared":true}
  // ----------------------------------------------------
  // Project Method: OT ObjectToBLOB (inObject; ioBLOB {; inAppend})
  ...
  // Pointer to a BLOB variable: OT ObjectToBLOB($h; ->$myBlob).
  // Use OT ObjectToNewBLOB for the simpler function-result form.
  ...
  // with *OT BLOBToObject*, not with *BLOB TO VARIABLE*.
  // 
  ...
  // variable or *OT ObjectToNewBLOB* instead.
  // 
  // **Note:** The object remains in memory after serialisation. Clear
  // it with *OT Clear* when no longer needed.
