...
// ----------------------------------------------------
// Project Method: OT GetReal (inObject; inTag) --> Real
...
//   guard, OT GetReal would silently succeed on a Longint property. Guard returns
...
If (OTr_z_IsValidHandle($inObject_i))
	If (OTr_z_ResolvePath(<>OTR_Objects_ao{$inObject_i}; $inTag_t; False:C215; \
		...
		If (OB Is defined:C1231($parent_o; $leafKey_t))
			If (OTr_z_MapType($parent_o; $leafKey_t)=Is real:K8:4)
