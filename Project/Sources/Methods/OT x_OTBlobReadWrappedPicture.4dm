...
// ----------------------------------------------------
// Project Method: OT x_OTBlobReadWrappedPicture (inBlob; inOffset; outEndOffset; outPicture) --> Boolean
...
Case of
	: ($format_t=".png")
		...
		While (($chunkStart_i+11)<$blobSize_i) & ($mediaEnd_i<0)
			...
			$chunkLen_i:=OT x_OTBlobReadUInt32BE($inBlob_blob; ->$chunkOffset_i)
