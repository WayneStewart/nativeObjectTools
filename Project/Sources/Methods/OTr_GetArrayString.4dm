...
// ----------------------------------------------------
// Project Method: OTr_GetArrayString (inObject; inTag; inIndex) --> Text
...
// OT GetArrayString gets a value in *inObject* from the array item referenced by
// *inTag*.
...
// array, use *OT GetArrayText* and assign to a text variable or field.
