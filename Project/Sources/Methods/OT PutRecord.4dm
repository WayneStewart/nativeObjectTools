...
// ----------------------------------------------------
// Project Method: OT PutRecord (inObject; inTag; inTable)
...
// moment OT PutRecord is called. Later database record changes are
// not reflected in the stored item unless OT PutRecord is called again.
...
//   date and time fields, matching the OT PutDate/OT PutTime strategy.
