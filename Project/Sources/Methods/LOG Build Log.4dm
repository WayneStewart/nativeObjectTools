...
// ----------------------------------------------------
// Project Method: LOG Build Log(text1{;text2..textN})
...
If (lg.enabled)
	...
	$logEntry_t:=OTr_z_timestampLocal+Storage:C1525.k.tab+$logEntry_t+Storage:C1525.k.return
	
	OTr_DummyVariableForTests_t:=OTr_DummyVariableForTests_t+$logEntry_t
End if 