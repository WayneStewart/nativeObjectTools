...
//   $ioOffset_ptr   : Pointer : Current read offset, advanced past parsed items
//   $inItemCount_i  : Integer : Number of embedded item records to parse
//
// Returns:
	...
	Else
		...
		Else
			...
			Case of
				...
				: ($typeByte_i=158)
					If (OTr_z_OTBlobReadBlobPayload($inBlob_blob; $ioOffset_ptr; ->$blob_blob))
