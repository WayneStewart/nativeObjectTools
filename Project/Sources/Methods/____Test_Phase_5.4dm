...
$total_i:=$total_i+1
If (($realVarOut_r>3.1415) & ($realVarOut_r<3.1417) & (OK=1))
	$passed_i:=$passed_i+1
Else 
	$failed_i:=$failed_i+1
...
$total_i:=$total_i+1
If (($textVarOut_t="hello-variable") & (OK=1))
	$passed_i:=$passed_i+1
Else 
	$failed_i:=$failed_i+1
...
$total_i:=$total_i+1
If (($boolVarOut_b=True:C214) & (OK=1))
	$passed_i:=$passed_i+1
Else 
	$failed_i:=$failed_i+1
...
$total_i:=$total_i+1
If (($boolVarOut_b=False:C215) & (OK=1))
	$passed_i:=$passed_i+1
Else 
	$failed_i:=$failed_i+1
...
$total_i:=$total_i+1
If (($dateVarOut_d=!2026-04-03!) & (OK=1))
	$passed_i:=$passed_i+1
Else 
	$failed_i:=$failed_i+1
...
$total_i:=$total_i+1
If ((Size of array:C274($longArr_ai)=3) & ($longArr_ai{1}=11) & ($longArr_ai{3}=33) & (OK=1))
	$passed_i:=$passed_i+1
Else 
	$failed_i:=$failed_i+1
