...
// ----------------------------------------------------
// Project Method: OT PutString (inObject; inTag; inValue)
...
//   Write shadow-type key (leafKey$type := OT Character = 112) so that OT ItemType
//   and OT GetString can reliably identify the stored type, and so that the type guard
