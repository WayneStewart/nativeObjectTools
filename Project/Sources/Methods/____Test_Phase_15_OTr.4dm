...
// Wayne Stewart, 2026-05-20 - Uncommented entire method body; previously the whole
//       file had been commented out, causing Phase 15 to record zero tests.
// ----------------------------------------------------
...
APPEND TO ARRAY($testNum_at; "1")
APPEND TO ARRAY($testName_at; "Creation / destruction")
...
APPEND TO ARRAY($testNum_at; "2")
APPEND TO ARRAY($testName_at; "String / Text")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
$otrResult_t:="Pass"
Else 
$otrResult_t:="Fail: got "+String($gotLong_i)
End if 

APPEND TO ARRAY($testNum_at; "3")
APPEND TO ARRAY($testName_at; "Longint")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
$otrResult_t:="Pass"
Else 
$otrResult_t:="Fail: got "+String($gotReal_r)
End if 

APPEND TO ARRAY($testNum_at; "4")
APPEND TO ARRAY($testName_at; "Real")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
OTr_PutBoolean($otrMain_i; "flag"; True)
$gotBool_i:=OTr_GetBoolean($otrMain_i; "flag")
If ($gotBool_i=1)
$otrResult_t:="Pass"
Else 
$otrResult_t:="Fail: got "+String($gotBool_i)
End if 

APPEND TO ARRAY($testNum_at; "5")
APPEND TO ARRAY($testName_at; "Boolean")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
$otrResult_t:="Pass"
Else 
$otrResult_t:="Fail: got "+String($gotDate_d)
End if 

APPEND TO ARRAY($testNum_at; "6")
APPEND TO ARRAY($testName_at; "Date")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
$otrResult_t:="Pass"
Else 
$otrResult_t:="Fail: got "+String($gotTime_h)
End if 

APPEND TO ARRAY($testNum_at; "7")
APPEND TO ARRAY($testName_at; "Time")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
If (OK=1) & ($gotPtr_ptr#Null)
If (($gotPtr_ptr->)=OTr_DummyVariableForTests_t)
$otrResult_t:="Pass"
Else 
$otrResult_t:="Fail: dereference got '"+String($gotPtr_ptr->)+"'"
End if 
Else 
...
APPEND TO ARRAY($testNum_at; "8")
APPEND TO ARRAY($testName_at; "Pointer")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
APPEND TO ARRAY($testNum_at; "9")
APPEND TO ARRAY($testName_at; "Picture (empty picture)")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
APPEND TO ARRAY($testNum_at; "9a")
APPEND TO ARRAY($testName_at; "Picture (wombat)")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
APPEND TO ARRAY($testNum_at; "10")
APPEND TO ARRAY($testName_at; "BLOB")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
APPEND TO ARRAY($testNum_at; "11")
APPEND TO ARRAY($testName_at; "Variable")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
APPEND TO ARRAY($testNum_at; "12")
APPEND TO ARRAY($testName_at; "Record")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
APPEND TO ARRAY($testNum_at; "13")
APPEND TO ARRAY($testName_at; "Dot-path")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
$otrResult_t:="Pass"
Else 
$otrResult_t:="Fail: got "+String($otrArrVal_i)
End if 

APPEND TO ARRAY($testNum_at; "14")
APPEND TO ARRAY($testName_at; "Array Longint")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
APPEND TO ARRAY($testNum_at; "15")
APPEND TO ARRAY($testName_at; "Array Text")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
$otrResult_t:="Pass"
Else 
$otrResult_t:="Fail: got "+String($otrArrReal_r)
End if 

APPEND TO ARRAY($testNum_at; "16")
APPEND TO ARRAY($testName_at; "Array Real")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
OTr_PutArrayBoolean($otrMain_i; "ab"; 1; True)
$otrArrBool_i:=OTr_GetArrayBoolean($otrMain_i; "ab"; 1)
If ($otrArrBool_i=1)
$otrResult_t:="Pass"
Else 
$otrResult_t:="Fail: got "+String($otrArrBool_i)
End if 

APPEND TO ARRAY($testNum_at; "17")
APPEND TO ARRAY($testName_at; "Array Boolean")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
APPEND TO ARRAY($testNum_at; "18")
APPEND TO ARRAY($testName_at; "Array Pointer")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
If (Picture size($otrArrPicOut_pic)>0)
$otrResult_t:="Pass"
Else 
$otrResult_t:="Fail: empty picture or OK=0"
End if 

APPEND TO ARRAY($testNum_at; "19")
APPEND TO ARRAY($testName_at; "Array Picture (empty picture)")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
APPEND TO ARRAY($testNum_at; "19a")
APPEND TO ARRAY($testName_at; "Array Picture (wombat)")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
$otrResult_t:="Pass"
Else 
$otrResult_t:="Fail: ItemExists="+String($gotItemExists_i)+" ItemType="+String($gotItemType_i)
End if 

APPEND TO ARRAY($testNum_at; "20")
APPEND TO ARRAY($testName_at; "Item info")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
$otrResult_t:="Pass"
Else 
$otrResult_t:="Fail: got "+String($otrCount_i)
End if 

OTr_Clear($h4_i)

APPEND TO ARRAY($testNum_at; "21")
APPEND TO ARRAY($testName_at; "Item count")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
ARRAY TEXT($otrPropNames_at; 0)
ARRAY LONGINT($otrTypes_ai; 0)
ARRAY LONGINT($otrItemSizes_ai; 0)
ARRAY LONGINT($otrDataSizes_ai; 0)
OTr_GetAllProperties($h4_i; ->$otrPropNames_at; ->$otrTypes_ai; ->$otrItemSizes_ai; ->$otrDataSizes_ai)
If (Size of array($otrPropNames_at)=2)
$otrResult_t:="Pass"
Else 
$otrResult_t:="Fail: got "+String(Size of array($otrPropNames_at))+" names"
End if 

OTr_Clear($h4_i)

APPEND TO ARRAY($testNum_at; "22")
APPEND TO ARRAY($testName_at; "Property enumeration")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
APPEND TO ARRAY($testNum_at; "23")
APPEND TO ARRAY($testName_at; "Delete / rename")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
APPEND TO ARRAY($testNum_at; "24")
APPEND TO ARRAY($testName_at; "Copy")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
$otrResult_t:="Pass"
Else 
$otrResult_t:="Fail: got "+String($otrArrSize_i)
End if 

APPEND TO ARRAY($testNum_at; "25")
APPEND TO ARRAY($testName_at; "Size of array")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
$otrResult_t:="Pass"
Else 
$otrResult_t:="Fail: first element after sort = "+String($gotLong_i)
End if 

OTr_Clear($h4_i)

APPEND TO ARRAY($testNum_at; "26")
APPEND TO ARRAY($testName_at; "Sort arrays")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
If ($otrSize_i>0)
$otrResult_t:="Pass (size="+String($otrSize_i)+")"
Else 
$otrResult_t:="Fail: returned 0 or OK=0"
End if 

APPEND TO ARRAY($testNum_at; "27")
APPEND TO ARRAY($testName_at; "Object size")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
APPEND TO ARRAY($testNum_at; "28")
APPEND TO ARRAY($testName_at; "BLOB serialisation")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
APPEND TO ARRAY($testNum_at; "29")
APPEND TO ARRAY($testName_at; "Version")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
$otrResult_t:="Pass"
Else 
$otrResult_t:="Fail: read "+String($readOtrOpts_i)+" expected "+String($testOpts_i)
End if 

APPEND TO ARRAY($testNum_at; "30")
APPEND TO ARRAY($testName_at; "Options")
APPEND TO ARRAY($otrCmd_at; $otrCmd_t)
APPEND TO ARRAY($otrResult_at; $otrResult_t)
...
$count_i:=Size of array($testNum_at)
