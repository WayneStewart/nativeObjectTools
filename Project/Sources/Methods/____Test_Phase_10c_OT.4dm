...
// ==== BEGIN OT BLOCK — comment out when plugin is absent ====
...
//$n_i:=$n_i+1
//OT PutArrayBoolean(99999; "longArr"; 1; True)
//$otCmd_t:="OT PutArrayBoolean(99999; \"longArr\"; 1; True)"
//$otResult_t:="OK="+String(OK)
//OTr_PutArrayText($accum_i; "otCmd"; $n_i; $otCmd_t)
//OTr_PutArrayText($accum_i; "otResult"; $n_i; $otResult_t)
...
//$n_i:=$n_i+1
//OT PutArrayBoolean($h_i; "longArr"; 1; True)
//$otCmd_t:="OT PutArrayBoolean($h_i; \"longArr\"; 1; True)"
//$otResult_t:="OK="+String(OK)
//OTr_PutArrayText($accum_i; "otCmd"; $n_i; $otCmd_t)
//OTr_PutArrayText($accum_i; "otResult"; $n_i; $otResult_t)
...
//$n_i:=$n_i+1
//OT PutBoolean(99999; "tag"; True)
//$otCmd_t:="OT PutBoolean(99999; \"tag\"; True)"
//$otResult_t:="OK="+String(OK)
//OTr_PutArrayText($accum_i; "otCmd"; $n_i; $otCmd_t)
//OTr_PutArrayText($accum_i; "otResult"; $n_i; $otResult_t)
...
//$n_i:=$n_i+1
//OT PutBoolean($h_i; "scalar"; True)
//$otCmd_t:="OT PutBoolean($h_i; \"scalar\"; True)"
//$otResult_t:="OK="+String(OK)
//OTr_PutArrayText($accum_i; "otCmd"; $n_i; $otCmd_t)
//OTr_PutArrayText($accum_i; "otResult"; $n_i; $otResult_t)
...
//$n_i:=$n_i+1
//ARRAY LONGINT($outArr_ai; 0)
//OT GetArray(99999; "longArr"; ->$outArr_ai)
//$otCmd_t:="OT GetArray(99999; \"longArr\"; ->$outArr_ai)"
//$otResult_t:="OK="+String(OK)
//OTr_PutArrayText($accum_i; "otCmd"; $n_i; $otCmd_t)
//OTr_PutArrayText($accum_i; "otResult"; $n_i; $otResult_t)
...
//$n_i:=$n_i+1
//ARRAY LONGINT($outArr_ai; 0)
//OT GetArray($h_i; "scalar"; ->$outArr_ai)
//$otCmd_t:="OT GetArray($h_i; \"scalar\"; ->$outArr_ai)"
//$otResult_t:="OK="+String(OK)
//OTr_PutArrayText($accum_i; "otCmd"; $n_i; $otCmd_t)
//OTr_PutArrayText($accum_i; "otResult"; $n_i; $otResult_t)
...
//$n_i:=$n_i+1
//$r_i:=OT GetArrayBLOB(99999; "longArr"; 1)
...
//$n_i:=$n_i+1
//$r_i:=OT GetArrayBLOB($h_i; "textArr"; 1)
...
//$n_i:=$n_i+1
//OT ObjectToBLOB(99999; ->$ioBLOB_blob; 0)
//$otCmd_t:="OT ObjectToBLOB(99999; ->$ioBLOB_blob; 0)"
//$otResult_t:="OK="+String(OK)
//OTr_PutArrayText($accum_i; "otCmd"; $n_i; $otCmd_t)
//OTr_PutArrayText($accum_i; "otResult"; $n_i; $otResult_t)
