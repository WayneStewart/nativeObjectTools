...
// ----------------------------------------------------
// Project Method: OT ObjectToNewBLOB (inObject) --> Blob
...
// issues associated with OT ObjectToBLOB.

// **ORIGINAL DOCUMENTATION**
// 
// *OT ObjectToNewBLOB* serialises an object into a new BLOB which
...
OT ObjectToBLOB($inObject_i; ->$result_blob)
