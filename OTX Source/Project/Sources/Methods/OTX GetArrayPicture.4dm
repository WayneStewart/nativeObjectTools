...
// ----------------------------------------------------
// Project Method: OTX GetArrayPicture
...
C_PICTURE:C286($0; $outArrayElement_pic)
...
//   OT GetArrayPicture(inObject; inTag; inIndex) => Number 
...
OTX GetArrayElement($inObject_i; $inTag_t; $inIndex_i; $MethodItemType_i; ->$outArrayElement_pic)

$0:=$outArrayElement_pic