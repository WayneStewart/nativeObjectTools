...
// ----------------------------------------------------
// Project Method: OTX PutArrayReal
...
//   If an item with the given tag exists and has the type Realint array, and inIndex is 
...
//   inObject        Realint     A handle to an object 
...
$MethodItemType_i:=Real array:K8:17

OTX PutArrayElement($inObject_i; $inTag_t; $inIndex_i; $MethodItemType_i; ->$inValue_r)