...
// ----------------------------------------------------
// Project Method: OTX PutArrayPicture
...
//   If an item with the given tag exists and has the type Pictureint array, and inIndex is 
...
//   inObject        Pictureint     A handle to an object 
...
$MethodItemType_i:=Picture array:K8:22

OTX PutArrayElement($inObject_i; $inTag_t; $inIndex_i; $MethodItemType_i; ->$inValue_pic)