...
// ----------------------------------------------------
// Project Method: OTX GetArrayPointer
...
//   OT GetArrayPointer(inObject; inTag; inIndex) => Number 
...
OTX GetArrayElement($inObject_i; $inTag_t; $inIndex_i; $MethodItemType_i; ->$outArrayElement_ptr)
