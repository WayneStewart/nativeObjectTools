...
// ----------------------------------------------------
// Project Method: OTX GetArrayLong
...
$inTag_t:=$2
$inIndex_i:=$3
$MethodItemType_i:=LongInt array:K8:19

OTX GetArrayElement($inObject_i; $inTag_t; $inIndex_i; $MethodItemType_i; ->$outArrayElement_i)
