...
// ----------------------------------------------------
// Project Method: OTX GetArrayDate
...
//   OT GetArrayDate(inObject; inTag; inIndex) => Number 
...
OTX GetArrayElement($inObject_i; $inTag_t; $inIndex_i; $MethodItemType_i; ->$outArrayElement_d)
