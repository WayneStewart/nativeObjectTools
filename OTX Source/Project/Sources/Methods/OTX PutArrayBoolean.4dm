...
// ----------------------------------------------------
// Project Method: OTX PutArrayBoolean
...
//   If an item with the given tag exists and has the type Booleanint array, and inIndex is 
...
//   inObject        Booleanint     A handle to an object 
...
$MethodItemType_i:=Boolean array:K8:21

OTX PutArrayElement($inObject_i; $inTag_t; $inIndex_i; $MethodItemType_i; ->$inValue_b)