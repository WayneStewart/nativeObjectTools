...
// ----------------------------------------------------
// Project Method: OTX PutArrayText
...
//   If an item with the given tag exists and has the type Textint array, and inIndex is 
...
//   inObject        Textint     A handle to an object 
...
OTX PutArrayElement($inObject_i; $inTag_t; $inIndex_i; $MethodItemType_i; ->$inValue_t)