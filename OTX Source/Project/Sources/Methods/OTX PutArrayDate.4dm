...
// ----------------------------------------------------
// Project Method: OTX PutArrayDate
...
//   If an item with the given tag exists and has the type Dateint array, and inIndex is 
...
//   inObject        Dateint     A handle to an object 
...
$MethodItemType_i:=Date array:K8:20

OTX PutArrayElement($inObject_i; $inTag_t; $inIndex_i; $MethodItemType_i; ->$inValue_d)