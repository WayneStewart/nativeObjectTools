...
var $settingsPath_t; $stagingDir_t; $projectPath_t : Text
var $compileOptions_o; $compileResult_o : Object
var $errors_c : Collection
var $error_o : Object
var $errorDetail_t; $line_t : Text
var $i_i : Integer

$variant_t:=Get environment variable("RELEASE_VARIANT")    // "OTr" or "OT"
$version_t:=Get environment variable("RELEASE_4D_VERSION") // "19", "20", or "21"
...
$settingsPath_t:=Replace string($settingsPath_t; "Project"+Folder separator; "")
$settingsPath_t:=$settingsPath_t+"BuildSettings"+Folder separator
